...
type ClusterGroupUpgradeSpec struct {
	...
	// This field restarts failed or otherwise non-progressing cgu
	//+kubebuilder:default=false
	//+operator-sdk:csv:customresourcedefinitions:type=spec,displayName="restart",xDescriptors={"urn:alm:descriptor:com.tectonic.ui:bool"}
