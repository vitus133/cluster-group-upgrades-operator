...
func (in *ClusterGroupUpgradeStatus) DeepCopyInto(out *ClusterGroupUpgradeStatus) {
	*out = *in
	...
	in.Status.DeepCopyInto(&out.Status)
	if in.PrecacheStatus != nil {
		in, out := &in.PrecacheStatus, &out.PrecacheStatus
		*out = make(map[string]ClusterPrecacheState, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterPrecacheState) DeepCopyInto(out *ClusterPrecacheState) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterPrecacheState.
func (in *ClusterPrecacheState) DeepCopy() *ClusterPrecacheState {
	if in == nil {
		return nil
	}
	out := new(ClusterPrecacheState)
	in.DeepCopyInto(out)
	return out
}
...
func (in *UpgradeStatus) DeepCopyInto(out *UpgradeStatus) {
	*out = *in
	...
	if in.CurrentRemediationPolicyIndex != nil {
		in, out := &in.CurrentRemediationPolicyIndex, &out.CurrentRemediationPolicyIndex
